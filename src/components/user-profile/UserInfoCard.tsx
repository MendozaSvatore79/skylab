...
export default function UserInfoCard() {
  ...
  const [labLogoBase64, setLabLogoBase64] = useState<string | null>(null);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (labLogoBase64) payload.labLogoBase64 = labLogoBase64;
      ...
      console.error(err);
      alert((err as any).message || 'Error saving');
    } finally {
      setIsSaving(false);
    }
  };
